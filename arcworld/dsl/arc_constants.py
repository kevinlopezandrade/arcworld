...
arc_constants_mapper = {
    ...
    "ORIGIN": {"type": ARC_TYPE.Coordinate, "value": ORIGIN},
    "UNITY": {"type": ARC_TYPE.Coordinate, "value": UNITY},
    "DOWN": {"type": ARC_TYPE.Coordinate, "value": DOWN},
    "RIGHT": {"type": ARC_TYPE.Coordinate, "value": RIGHT},
    "UP": {"type": ARC_TYPE.Coordinate, "value": UP},
    "LEFT": {"type": ARC_TYPE.Coordinate, "value": LEFT},
    "NEG_TWO": {"type": ARC_TYPE.Integer, "value": NEG_TWO},
    "NEG_UNITY": {"type": ARC_TYPE.Coordinate, "value": NEG_UNITY},
    "UP_RIGHT": {"type": ARC_TYPE.Coordinate, "value": UP_RIGHT},
    "DOWN_LEFT": {"type": ARC_TYPE.Coordinate, "value": DOWN_LEFT},
    "TWO_BY_TWO": {"type": ARC_TYPE.Coordinate, "value": TWO_BY_TWO},
    "THREE_BY_THREE": {"type": ARC_TYPE.Coordinate, "value": THREE_BY_THREE},
    "ZERO_BY_TWO": {"type": ARC_TYPE.Coordinate, "value": ZERO_BY_TWO},
    "TWO_BY_ZERO": {"type": ARC_TYPE.Coordinate, "value": TWO_BY_ZERO},
}
