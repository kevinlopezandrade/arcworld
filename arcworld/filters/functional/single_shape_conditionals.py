...
def is_shape_antidiagonally_symmetric(shape):
    ...
    return is_shape_diagonally_symmetric(ShapeObject(flipped_cropped_grid))
...
def is_shape_more_than_7_cell(shape):
    return shape.num_points > 7


def is_shape_more_than_8_cell(shape):
    return shape.num_points > 8


def is_shape_more_than_9_cell(shape):
    return shape.num_points > 9


def is_shape_more_than_10_cell(shape):
    return shape.num_points > 10


def is_shape_more_than_11_cell(shape):
    return shape.num_points > 11


def is_shape_more_than_12_cell(shape):
    return shape.num_points > 12


def is_shape_more_than_13_cell(shape):
    return shape.num_points > 13


def is_shape_more_than_14_cell(shape):
    return shape.num_points > 14


def is_shape_more_than_15_cell(shape):
    return shape.num_points > 15
...
def is_shape_less_than_7_cell(shape):
    return shape.num_points < 7


def is_shape_less_than_8_cell(shape):
    return shape.num_points < 8


def is_shape_less_than_9_cell(shape):
    return shape.num_points < 9


def is_shape_less_than_10_cell(shape):
    return shape.num_points < 10


def is_shape_less_than_11_cell(shape):
    return shape.num_points < 11


def is_shape_less_than_12_cell(shape):
    return shape.num_points < 12


def is_shape_less_than_13_cell(shape):
    return shape.num_points < 13


def is_shape_less_than_14_cell(shape):
    return shape.num_points < 14


def is_shape_less_than_15_cell(shape):
    return shape.num_points < 15


def is_shape_less_than_15_rows(shape):
    return shape.n_rows < 15


def is_shape_less_than_14_rows(shape):
    return shape.n_rows < 14


def is_shape_less_than_13_rows(shape):
    return shape.n_rows < 13


def is_shape_less_than_12_rows(shape):
    return shape.n_rows < 12
...
def is_shape_less_than_10_rows(shape):
    return shape.n_rows < 10
...
def is_shape_less_than_8_rows(shape):
    return shape.n_rows < 8


def is_shape_less_than_7_rows(shape):
    return shape.n_rows < 7
...
def is_shape_less_than_15_cols(shape):
    return shape.n_cols < 15


def is_shape_less_than_14_cols(shape):
    return shape.n_cols < 14


def is_shape_less_than_13_cols(shape):
    return shape.n_cols < 13


def is_shape_less_than_12_cols(shape):
    return shape.n_cols < 12
...
def is_shape_less_than_10_cols(shape):
    return shape.n_cols < 10
...
def is_shape_less_than_8_cols(shape):
    return shape.n_cols < 8


def is_shape_less_than_7_cols(shape):
    return shape.n_cols < 7
...
CONDITIONALS = {
    ...
    "is_shape_more_than_7_cell": is_shape_more_than_7_cell,
    "is_shape_more_than_8_cell": is_shape_more_than_8_cell,
    "is_shape_more_than_9_cell": is_shape_more_than_9_cell,
    "is_shape_more_than_10_cell": is_shape_more_than_10_cell,
    "is_shape_more_than_11_cell": is_shape_more_than_11_cell,
    "is_shape_more_than_12_cell": is_shape_more_than_12_cell,
    "is_shape_more_than_13_cell": is_shape_more_than_13_cell,
    "is_shape_more_than_14_cell": is_shape_more_than_14_cell,
    "is_shape_more_than_15_cell": is_shape_more_than_15_cell,
    ...
    "is_shape_less_than_7_cell": is_shape_less_than_7_cell,
    "is_shape_less_than_8_cell": is_shape_less_than_8_cell,
    "is_shape_less_than_9_cell": is_shape_less_than_9_cell,
    "is_shape_less_than_10_cell": is_shape_less_than_10_cell,
    "is_shape_less_than_11_cell": is_shape_less_than_11_cell,
    "is_shape_less_than_12_cell": is_shape_less_than_12_cell,
    "is_shape_less_than_13_cell": is_shape_less_than_13_cell,
    "is_shape_less_than_14_cell": is_shape_less_than_14_cell,
    "is_shape_less_than_15_cell": is_shape_less_than_15_cell,
    ...
    "is_shape_less_than_7_rows": is_shape_less_than_7_rows,
    "is_shape_less_than_8_rows": is_shape_less_than_8_rows,
    "is_shape_less_than_9_rows": is_shape_less_than_9_rows,
    "is_shape_less_than_10_rows": is_shape_less_than_10_rows,
    "is_shape_less_than_11_rows": is_shape_less_than_11_rows,
    "is_shape_less_than_12_rows": is_shape_less_than_12_rows,
    "is_shape_less_than_13_rows": is_shape_less_than_13_rows,
    "is_shape_less_than_14_rows": is_shape_less_than_14_rows,
    "is_shape_less_than_15_rows": is_shape_less_than_15_rows,
    ...
    "is_shape_less_than_7_cols": is_shape_less_than_7_cols,
    "is_shape_less_than_8_cols": is_shape_less_than_8_cols,
    "is_shape_less_than_9_cols": is_shape_less_than_9_cols,
    "is_shape_less_than_10_cols": is_shape_less_than_10_cols,
    "is_shape_less_than_11_cols": is_shape_less_than_11_cols,
    "is_shape_less_than_12_cols": is_shape_less_than_12_cols,
    "is_shape_less_than_13_cols": is_shape_less_than_13_cols,
    "is_shape_less_than_14_cols": is_shape_less_than_14_cols,
    "is_shape_less_than_15_cols": is_shape_less_than_15_cols,
