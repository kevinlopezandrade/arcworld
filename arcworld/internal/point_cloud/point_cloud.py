...
from arcworld.internal.constants import ALLOWED_COLORS, MAX_GRID_SIZE
from arcworld.internal.point_cloud.utils import (
    pc_to_full_sized_grid,
    pc_to_shape_only_grid,
)
...
class PointCloud(DictWrapper):
    ...
    def bounding_corners(self):
        """Returns the lower left and the top right corner of the bounding box of
        the object"""
