...
class ShapeObject:
    def __init__(self, data):
        ...
        if isinstance(data, ShapeObject):
            self.pc = data.pc
    ...
    def bounding_corners(self):
        """Returns the lower left and the top right corner of
...
class BasicShape(ShapeObject):
    def __init__(self, max_n_rows: int, max_n_cols: int, color_pattern: str):
